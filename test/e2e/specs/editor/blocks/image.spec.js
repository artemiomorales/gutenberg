...
test.describe( 'Image - lightbox', () => {
	...
	// Lightbox tests have been reenabled in https://github.com/WordPress/gutenberg/pull/60150/ but this test needs to be updated
	test.describe.skip(
		'should open and close the image in a lightbox when using a mouse and dynamically load src',
		() => {
	...
	// Lightbox tests have been reenabled in https://github.com/WordPress/gutenberg/pull/60150/ but this test needs to be updated
	test.skip( 'lightbox should be overriden when link is configured for image', async ( {
		editor,
		page,
		imageBlockUtils,
	} ) => {
	...
	// Lightbox tests have been reenabled in https://github.com/WordPress/gutenberg/pull/60150/ but this test needs to be updated
	test.skip( 'markup should not appear if Lightbox is disabled', async ( {
		editor,
		page,
		imageBlockUtils,
	} ) => {
	...
	// Lightbox tests have been reenabled in https://github.com/WordPress/gutenberg/pull/60150/ but this test needs to be updated
	test.skip( 'lightbox should work as expected when inserting image from URL', async ( {
		editor,
		page,
	} ) => {
		await editor.openDocumentSettingsSidebar();
